              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <p className="font-medium">{order.customer.email || 'No especificado'}</p>
                    </div>
                    <div>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <p className="text-xs text-gray-500">Folio: {order.folio}</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 ml-4">
                  ...
                  <button
                    ...
                    disabled={refreshing}
                    className="px-3 py-2 bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-200 text-sm font-medium disabled:opacity-50 transition"
                  >
                    Editar
                  </button>
                  <button
                    ...
                    disabled={refreshing}
                    className="px-3 py-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 text-sm font-medium disabled:opacity-50 transition"
                  >
                    Eliminar
                  </button>
                </div>
